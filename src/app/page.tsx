...
export default function Home() {
  ...
  return (
    <main className="mt-20 p-16 flex flex-col items-center gap-4">
      <h1 className="w-fit mx-auto text-4xl md:text-6xl font-extrabold tracking-tighter px-6 py-1 rounded-full border-yellow-400 border-8 bg-yellow-300">Welcome to <span className="underline">QuizBuzz</span></h1>
